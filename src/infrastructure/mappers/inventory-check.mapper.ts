import { Prisma, InventoryCheck as PrismaInventoryCheck } from 'generated/prisma/client';
...
export class InventoryCheckMapper {
    ...
    static toPersistence(inventoryCheck: InventoryCheck): Prisma.InventoryCheckCreateArgs {
        return {
            data: {
