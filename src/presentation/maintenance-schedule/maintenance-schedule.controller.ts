...
} from 'src/application/commands/maintenance-schedule';
import {
...
import { GetMaintenanceSchedulesQuery, GetMaintenanceScheduleByIdQuery } from 'src/application/queries/maintenance-schedule';
import {
...
export class MaintenanceScheduleController {
    ...
    async complete(
        ...
        const cmd = new CompleteMaintenanceCommand(id, dto.result, dto.actualCost || null);
    ...
    async getList(
        ...
        const q = new GetMaintenanceSchedulesQuery(
            organizationId || '',
            {
    ...
    private toResponse(entity: any): MaintenanceScheduleResponse {
