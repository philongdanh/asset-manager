...
import { GetMaintenanceSchedulesQuery } from '../maintenance-schedule/get-maintenance-schedules.query';
...
export class GetMaintenanceSchedulesHandler {
    ...
    async execute(query: GetMaintenanceSchedulesQuery): Promise<{ data: MaintenanceSchedule[]; total: number }> {
